...
public abstract class ChangeScene {
    ...
    public static ChangeScene add(String name) {
        ChangeScene controller = controllers.get(name);
        ...
        if(controller == null){
            try 
            {
                ...
                Logger.getLogger(ChangeScene.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static ChangeScene getControllerByName(String name) {
